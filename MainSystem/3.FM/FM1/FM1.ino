...
double GOAL_lat = 35.862033333;
double GOAL_lng = 139.606135000; 
...
int outputcutsecond = 8;    // 切り離し時の9V電圧を流す時間，単位はsecond
    ...
    { 
        ...
        switch(phase)
        {
          ...
          case 6:
            if(phase_state != 6)
            {
              Serial2.println("Phase6: transition completed");
              // LogDataの保存
              CanSatLogData.println(gps_time);
            ...
            switch (phase_5)
            {
              ...
              case 1:
                ...
                Serial2.print("phase(rotating)=");
                Serial2.println(phase_5);
              ...
              case 2:
                Serial2.print("phase(check_former)=");
                Serial2.println(phase_5);
              ...
              case 4:
                Serial2.print("phase(check_later)=");
                Serial2.println(phase_5);
                if (abs(current_distance - previous_distance) < EPSILON)
                {
                  count++;
              ...
              case 6:
                Serial2.print("phase(goal)=");
                Serial2.println(phase_5);
                Serial2.println("GOAL!");
                CanSatLogData.println("-----------------------");
